            ...
            <div class="col-md-12" style="padding:10px">
                <div class="card ">
                    <div class="card-header">
                        ...
                        <button
                            class="btn btn-outline-dark btn-sm float-end me-2"
                            @click="$router.back()"
                        >
                            <i class="fas fa-arrow-left"></i> Back
                        </button>
                        <h5 class="card-title">
                            {{ category ? category.title : "" }} Sub Categories
                        </h5>
                    </div>
                    <!-- /.card-header -->
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td>
                                        <router-link
                                            :to="
                                                `/admin/category/${category.id}/sub-category/${subCategory.id}/sub-categories`
                                            "
                                            :title="
                                                'Show ' +
                                                    subCategory.title +
                                    ...
                                    <td>{{ subCategory.ar_title }}</td>
                                    <td>{{ subCategory.description }}</td>
                                    <td>{{ subCategory.ar_description }}</td>
                                    <td>
                                        <img
                                    ...
                                    <td>
                                        ...
                                        <a
                                            ...
                                            :disabled="deleting == subCategory"
                                        >
                                            <b-spinner
                                                small
                                                v-if="deleting == subCategory"
                                            ></b-spinner>
                                            <i
                                                v-else
                ...
                <div class="modal-content">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <textarea
                                        ...
                                        class="form-control"
                                        id="description"
                                        v-model="sub_category.ar_description"
                    ...
                    <div class="modal-footer">
                        ...
                        <button
                            v-if="!editMode"
                            @click="postCategory"
                            :disabled="loading || !sub_category.title"
                            type="button"
...
export default {
    ...
    methods: {
        getSubCategories() {
            ...
            axios
                .post(
                    `/api/category/${this.$route.params.cat_id}/sub-categories`
                )
                .then(res => {
                    console.log(res);
        ...
        postCategory() {
            if (this.sub_category.title) {
                ...
                axios
                    .post("/api/sub-category/store", fd, {
                        headers: {
        ...
        updateCategory() {
            if (this.sub_category.title) {
                ...
                axios
                    .post(
                        "/api/sub-category/" + this.sub_category.id + "/update",
                        fd,
                        {
                            headers: {
                                "Content-Type": "multipart/form-data"
                            },
                            onUploadProgress: function(progressEvent) {}.bind(
                                this
                            )
                        }
                    )
        ...
        editCategory(sub_category) {
            ...
            if (sub_category.image) {
                this.newImageSrc =
                    "/storage/sub-categories/" + sub_category.image;
            }
            $("#categoryModal").modal("show");
        },
        deleteCategory(sub_category) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    axios
                        .post(
                            "/api/sub-category/ " + sub_category.id + " /delete"
                        )
                        .then(res => {
                            // console.log(res)
                            this.deleting = "";
